...
parser.add_argument('--sourcepath',type = str, default = './Image/', help ='Path of class to convert')
parser.add_argument('--dest_path',type=str, required=True, default='./Annotation_jh/',help='Path of Dest XML files')
